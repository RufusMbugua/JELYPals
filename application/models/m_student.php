 ...
 */
use application\models\Entities\E_Jely_Student;

class M_Trainers extends MY_Model {
	var $isUser, $email, $userRights, $affiliation;
	var $id, $attr, $frags, $elements, $theIds, $noOfInserts, $batchSize, $students;
	...
	function getStudent() {
		...
		if ($this -> input -> post()) {//check if a post was made
			...
			//$user = $this -> em -> getRepository('models\Entities\E_Jely_Student') -> findOneBy(array('email' => $this -> input -> post('email'), 'password' => $this -> input -> post('password')));
